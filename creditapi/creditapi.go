// Package creditapi defines the public types and interfaces for the goop2
// credit system. This package lives outside internal/ so that external modules
// (e.g. goop2-credits) can implement CreditProvider.
package creditapi
