...
(function () {
  ...
  window.Goop.api = {
    ...
    groups: {
      ...
      setRole:            function (p) { return _post('/api/groups/set-role', p); },
      setDefaultRole:     function (p) { return _post('/api/groups/set-default-role', p); },
      setGroupRoles:      function (p) { return _post('/api/groups/set-roles', p); },
    ...
    cluster: {
      ...
      clear:   function ()  { return _post('/api/cluster/clear'); },
      ...
      pause:   function ()  { return _post('/api/cluster/pause'); },
      resume:  function ()  { return _post('/api/cluster/resume'); },
      pauseWorker:  function (p) { return _post('/api/cluster/worker/pause', p); },
      resumeWorker: function (p) { return _post('/api/cluster/worker/resume', p); },
    ...
    schema: {
      ...
      setRoles:   function (p) { return _post('/api/data/schemas/set-roles', p); },
    },
    ...
    // ── Transformations ────────────────────────────────────────────────────
    transform: {
      list:       function ()  { return _get('/api/data/transformations'); },
      get:        function (p) { return _post('/api/data/transformations/get', p); },
      save:       function (p) { return _post('/api/data/transformations/save', p); },
      delete:     function (p) { return _post('/api/data/transformations/delete', p); },
      preview:    function (p) { return _post('/api/data/transformations/preview', p); },
