...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.clusterJobIDRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "not a worker or job not pending",
                        "schema": {
                            "type": "string"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.clusterHeartbeatRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.clusterProgressRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.clusterResultRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "routes.clusterHeartbeatRequest": {
            "type": "object",
            "properties": {
                "stats": {
                    "type": "object",
        ...
        "routes.clusterProgressRequest": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "processing frame 84/200"
                },
                "percent": {
                    "type": "integer",
                    "example": 42
